...
data Viewport = Viewport { _viewportX :: Int
                         , _viewportY :: Int
                         , _viewportW :: Int
                         , _viewportH :: Int
                         } deriving (Show)
...
setViewport (Viewport x y w h) = GL.viewport $= (GL.Position (fromIntegral x) (fromIntegral y), GL.Size (fromIntegral w) (fromIntegral h))
--data Rect = Rect
--	{ rectPos :: V2 Float
--	, rectSize :: V2 Float
--	}
